...
public class ExtraToppingTrigger extends SimpleCriterionTrigger<ExtraToppingTrigger.Instance> {

    public static final ResourceLocation ID = MaturiDelight.prefix("extra_topping");
    ...
    public static class Instance extends AbstractCriterionTriggerInstance {
        public Instance(ContextAwarePredicate player) {
            super(ExtraToppingTrigger.ID, player);
        }
